              ...
              <form>
                <div className="flex w-full justify-between">
                  <div className="w-2/5">
                    ...
                    <input
                      type="text"
                      className="border-2 border-white w-full bg-background p-1 outline-none rounded-md"
                    />
                  </div>
                  <div className="w-2/5">
                ...
                <div className="my-5">
                  ...
                  <input
                    type="text"
                    className="border-2 w-full border-white bg-background p-1 outline-none rounded-md"
                  />
                </div>
                <div className="my-5">
